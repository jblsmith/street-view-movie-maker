...
for i in range(10,200):
	...
	if probe['status']=="OK" and 'Google' in probe['copyright']:
		dest_file = download_streetview_image(gps_point, filename="ottawa_montreal" + str(i), heading=heading, size="640x640", get_metadata=False)
...
import subprocess
import os.system
def line_up_files(filestem, tmpstem = "./photos/tmp_line_up"):
...
ffmpeg -r 20 -f image2 -s 600x600 -i tmp_photos/arizona%d.jpg -vcodec libx264 -crf 25 -pix_fmt yuv420p tmp_arizona.mp4
